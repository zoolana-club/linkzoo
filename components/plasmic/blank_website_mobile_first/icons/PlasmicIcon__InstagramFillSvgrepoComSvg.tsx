...
export type InstagramFillSvgrepoComSvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function InstagramFillSvgrepoComSvgIcon(
  props: InstagramFillSvgrepoComSvgIconProps
) {
...
export default InstagramFillSvgrepoComSvgIcon;
/* prettier-ignore-end */
