...
export type Twitter3SvgrepoCom1SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Twitter3SvgrepoCom1SvgIcon(
  props: Twitter3SvgrepoCom1SvgIconProps
) {
...
export default Twitter3SvgrepoCom1SvgIcon;
/* prettier-ignore-end */
