...
export type TelegramSvgrepoCom5SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function TelegramSvgrepoCom5SvgIcon(
  props: TelegramSvgrepoCom5SvgIconProps
) {
...
export default TelegramSvgrepoCom5SvgIcon;
/* prettier-ignore-end */
